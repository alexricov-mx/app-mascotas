...
3. `docs/02-requerimiento.md`: **única fuente de verdad** del producto (versión 3.8).
...
7. `docs/06-modelo-conceptual.md`: modelo conceptual del dominio por bloques (bloques 1 a 3 aprobados).
...
2. Modelo conceptual del dominio (`docs/06-modelo-conceptual.md`), por bloques, separando núcleo genérico y vertical de mascotas. Bloques 1 a 3 aprobados (identidad y acceso; suscripciones, planes y parámetros; mascotas, propiedad y espacios); sigue el bloque 4 (vinculación, privacidad y consentimientos).
