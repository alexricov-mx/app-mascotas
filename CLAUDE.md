...
3. `docs/02-requerimiento.md`: **única fuente de verdad** del producto (versión 3.13).
...
7. `docs/06-modelo-conceptual.md`: modelo conceptual del dominio por bloques (bloques 1 a 7 aprobados).
