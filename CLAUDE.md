...
3. `docs/02-requerimiento.md`: **única fuente de verdad** del producto (versión 3.7).
...
7. `docs/06-modelo-conceptual.md`: modelo conceptual del dominio por bloques (bloques 1 y 2 aprobados).
...
2. Modelo conceptual del dominio (`docs/06-modelo-conceptual.md`), por bloques, separando núcleo genérico y vertical de mascotas. Bloques 1 (identidad y acceso) y 2 (suscripciones, planes y parámetros) aprobados; sigue el bloque 3 (mascotas, propiedad y espacios).
