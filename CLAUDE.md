...
3. `docs/02-requerimiento.md`: **única fuente de verdad** del producto (versión 3.6).
...
7. `docs/06-modelo-conceptual.md`: modelo conceptual del dominio por bloques (bloque 1, identidad y acceso, aprobado).
...
2. Modelo conceptual del dominio (`docs/06-modelo-conceptual.md`), por bloques, separando núcleo genérico y vertical de mascotas. Bloque 1 (identidad y acceso) aprobado; sigue el bloque 2 (suscripciones, planes y parámetros).
