...
3. `docs/02-requerimiento.md`: **única fuente de verdad** del producto (versión 3.11).
...
7. `docs/06-modelo-conceptual.md`: modelo conceptual del dominio por bloques (bloques 1 a 6 aprobados).
