...
| `02-requerimiento.md` | **Única fuente de verdad** del producto (versión 3.11, 2026-09-24). |
| `03-casos-uso-mvp.md` | Casos de uso del MVP (versión 1.10, aprobados). |
...
| `06-modelo-conceptual.md` | Modelo conceptual del dominio por bloques; bloques 1 a 6 aprobados. |
...
**Siguiente paso:** continuar el modelo conceptual con el bloque 7 (inventario, promociones y ventas); los bloques 1 a 6 ya están aprobados. Después: matriz de roles y permisos → modelo de privacidad → modelo de datos físico en PostgreSQL. No se empieza por tablas.
