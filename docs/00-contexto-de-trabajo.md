...
| `02-requerimiento.md` | **Única fuente de verdad** del producto (versión 3.7, 2026-09-24). |
| `03-casos-uso-mvp.md` | Casos de uso del MVP (versión 1.6, aprobados). |
...
| `06-modelo-conceptual.md` | Modelo conceptual del dominio por bloques; bloques 1 y 2 aprobados. |
...
**Siguiente paso:** continuar el modelo conceptual con el bloque 3 (mascotas, propiedad y espacios); los bloques 1 y 2 ya están aprobados. Después: matriz de roles y permisos → modelo de privacidad → modelo de datos físico en PostgreSQL. No se empieza por tablas.
